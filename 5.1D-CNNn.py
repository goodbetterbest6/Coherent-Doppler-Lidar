...
class MyCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(in_channels=1, out_channels=16, kernel_size=21, stride=10, padding=10)
        self.pool1 = nn.AvgPool1d(kernel_size=2, stride=2)
        self.conv2 = nn.Conv1d(in_channels=16, out_channels=32, kernel_size=11, stride=5, padding=5)
        self.pool2 = nn.AvgPool1d(kernel_size=2, stride=2)
        self.conv3 = nn.Conv1d(in_channels=32, out_channels=64, kernel_size=21, stride=5, padding=10)
        self.pool3 = nn.AvgPool1d(kernel_size=2, stride=2)
        self.conv4 = nn.Conv1d(in_channels=64, out_channels=64, kernel_size=21, stride=5, padding=10)
        self.pool4 = nn.AvgPool1d(kernel_size=2, stride=2)
        self.conv5 = nn.Conv1d(in_channels=64, out_channels=64, kernel_size=21, stride=5, padding=10)
...
input_data = torch.from_numpy(ti)
print(ti.shape)
target_data = torch.from_numpy(tt.reshape(tt.shape[0], 1))
